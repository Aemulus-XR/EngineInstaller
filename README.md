# EngineInstaller [![starline](https://starlines.qoo.monster/assets/Aemulus-XR/EngineInstaller)](https://github.com/qoomon/starline)
<div align="center">

  <img src="assets/media/logo.jpg" alt="logo" width="200" height="auto" />
    <h1><a href="https://github.com/Aemulus-XR/EngineInstaller">Aemulus-XR/EngineInstaller</a></h1>
  <h3>Nulla nobis dicta iste minus dolor repellendus aspernatur atque</h3>
  
  
<!-- Badges -->
<p>
  <a href="https://github.com/Aemulus-XR/EngineInstaller/graphs/contributors">
    <img src="https://img.shields.io/github/contributors/Aemulus-XR/EngineInstaller" alt="contributors" />
  </a>
  <a href="">
    <img src="https://img.shields.io/github/last-commit/Aemulus-XR/EngineInstaller" alt="last update" />
  </a>
  <a href="https://github.com/Aemulus-XR/EngineInstaller/network/members">
    <img src="https://img.shields.io/github/forks/Aemulus-XR/EngineInstaller" alt="forks" />
  </a>
  <a href="https://github.com/Aemulus-XR/EngineInstaller/stargazers">
    <img src="https://img.shields.io/github/stars/Aemulus-XR/EngineInstaller" alt="stars" />
  </a>
  <a href="https://github.com/Aemulus-XR/EngineInstaller/issues/">
    <img src="https://img.shields.io/github/issues/Aemulus-XR/EngineInstaller" alt="open issues" />
  </a>
  <a href="https://github.com/Aemulus-XR/EngineInstaller/blob/main/LICENSE.md">
    <img src="https://img.shields.io/github/license/Aemulus-XR/EngineInstaller.svg" alt="license" />
  </a>
...
<h4>
  ...
  <span> · </span>
    <a href="https://github.com/Aemulus-XR/EngineInstaller/blob/main/README.md">Documentation</a>
  <span> · </span>
    <a href="https://github.com/Aemulus-XR/EngineInstaller/issues/new?template=bug_report.md">Report Bug</a>
  <span> · </span>
    <a href="https://github.com/Aemulus-XR/EngineInstaller/issues/new?template=feature_request.md">Request Feature</a>
  </h4>
</div>
...
Branches
--------
`main` is the [deployed](https://Aemulus-XR.github.io/EngineInstaller/) branch.  The repo doesn't currently contain any other historic or dev branches.
...
-----------------------
- Please [file an issue](https://github.com/Aemulus-XR/EngineInstaller/issues/new), or [grab a fork](https://github.com/Aemulus-XR/EngineInstaller/fork), hack away, and submit a [pull request](https://github.com/Aemulus-XR/EngineInstaller/pulls).
...
Project Link:  [EngineInstaller](https://github.com/Aemulus-XR/EngineInstaller)  
