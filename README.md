...
<div align="center">
  ...
  <img src="assets/media/logo.jpg" alt="logo" width="200" height="auto" />
    <h1><a href="https://github.com/Aemulus-XR/EngineInstaller">EngineInstaller</a></h1>
  <h3>WiX-based installer for Unreal Engine 5.6 OculusDrop Edition</h3>
...
**EngineInstaller** is a WiX-based installer for a custom build of Unreal Engine 5.6 (OculusDrop edition). It packages the engine build generated by the UEOculusDrop repository and creates a user-friendly MSI installer for distribution.
...
1. Download the latest `UE-5.6-OculusDrop.msi` from releases
...
- **Start Menu**: "Unreal Engine 5.6" → "Unreal Editor 5.6"
...
- Contact information: [Update with your contact details]
